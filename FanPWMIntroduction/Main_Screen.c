...
void Update_Screen(void)
{
    ...
    DC_Txt[0] = duty_cycle/100  + '0'; //Divide by 100  for hundreds spot of duty cycle
    // modify the lines below    
    DC_Txt[1] = duty_cycle/10%10+'0'; //divide by 10 modulo 10 for tens spot
    DC_Txt[2] = duty_cycle%10+ '0';   //modulo 10 for ones spot

    
    RPM_Txt[0] = rpm/1000  + '0';//divide by 1000 for thousands spot
    // modify the lines below        
    RPM_Txt[1] = rpm/100%10+'0';  //divide by 100 modulo 10 for 100s spot
    RPM_Txt[2] = rpm/10%10+'0'; // divide by 10 modulo 10 for 10s spot
    RPM_Txt[3] = rpm%10+'0';   //modulo 10 for 1s spot
