...
#define SCL_PIN PORTDbits.RD2 //PIN = PORT
#define SCL_DIR TRISDbits.RD2 //DIR = TRIS 
#define SDA_PIN PORTDbits.RD3 //PIN = PORT
#define SDA_DIR TRISDbits.RD3 // DIR = TRIS

void I2C_Init(unsigned long c) //provided by professor
{
   i2cHighScl();
   i2cHighSda();
}

unsigned char I2C_Read(char ack) //provided by professor
{
...
void I2C_Write(unsigned char outByte ) //provided by professor
{
   unsigned char n;
   for(n=0; n<8; n++)
   {
